...
export class CreateCursoDto {
  @ApiProperty({
    ...
    example: 'Diplomado DREAVA Módulo 4',
  })
  @IsNotEmpty()
  @IsString()
  nombre: string;
  ...
  @ApiProperty({
    ...
    example:
      'Capacitar al personal docente en el uso de herramientas tecnológicas para el desarrollo',
  })
  @IsNotEmpty()
  @IsString()
  objetivo: string;
  ...
  @ApiProperty({
    description: 'ID del periodo al que pertenece el curso',
    example: 1,
  })
  @IsNotEmpty()
  @IsNumber()
  ...
  @ApiProperty({
    description: 'ID de la academia que propone el curso',
    example: 1,
  })
  @IsNotEmpty()
  @IsNumber()
  ...
  @ApiProperty({
    description: 'ID del usuario que será instructor',
    example: 5,
  })
  @IsNotEmpty()
  @IsNumber()
  ...
  @ApiProperty({
    description: 'Aula o espacio donde se impartirá',
    example: 'Aula 2-2',
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiProperty({
    description: 'Hora de inicio de las sesiones',
    example: '08:00',
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiProperty({
    description: 'Hora de finalización de las sesiones',
    example: '14:00',
  })
  @IsNotEmpty()
  @IsString()
